...
func GrantDatastorePrivileges(ctx context.Context, server, protocol, role, password, targetRole, datastore, resources, accessTypes string) error {
	return updateDatastoreAccessTypes(ctx, server, protocol, role, password, targetRole, "grant", datastore, resources, accessTypes)
}

func RevokeDatastorePrivileges(ctx context.Context, server, protocol, role, password, targetRole, datastore, resources, accessTypes string) error {
	return updateDatastoreAccessTypes(ctx, server, protocol, role, password, targetRole, "revoke", datastore, resources, accessTypes)
}

func updateDatastoreAccessTypes(ctx context.Context, server, protocol, role, password, targetRole, operation, datastore, resources, accessTypes string) error {
	logger := utils.LoggerFromContext(ctx)
	client := utils.HttpClientFromContext(ctx)
	...
	bodyString := fmt.Sprintf("resource-specifier=|datastores|%s|%s&access-types=%s", datastore, resources, accessTypes)
