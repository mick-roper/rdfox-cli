...
func GetStats(ctx context.Context, server, protocol, role, password, datastore string) (rdfox.Statistics, error) {
...
func parseStats(r io.Reader) rdfox.Statistics {
	scanner := bufio.NewScanner(r)
	scanner.Split(bufio.ScanLines)

	stats := rdfox.Statistics{}
	thisComponent := ""
	scanner.Split(bufio.ScanLines)
